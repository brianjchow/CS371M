...
/**
 * Create a login button with the provided label and target.
 * This method is a modification of the one provided in auth.js
 * by ForgeRock, some html id's and classes are different.
 *
 * @param label of button
 * @param href of button
 */
function markupButtonUT(label, href) {
    label = strTrim(label);
    document.write("<td>");
    document.write("<div id=\"login_btn\">");
        ...
        setTimeout(function() {
            ...
            jQuery("#loginForm").html(
                "<p aria-live='assertive'><br/><br/>This login page is active for a limited period "
                    + "of time for security purposes. Please <a href='#' id='reloadAnchor'>reload</a> "
                    + "this page to login.<br/><br/><br/></p>");
